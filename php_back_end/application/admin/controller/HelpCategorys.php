...
class HelpCategorys extends ApiCommon
{
    // 【 帮助中心文章类目 】查询出列表
    public function listdata()
    {
        $param = $this->param;
        $objModel = model('HelpCategory');
        $map['status'] = 1;
