...
class GoodsCategorys extends ApiCommon
{
    // 【租赁方案类目】查询出列表
    public function listdata()
    {
        $param = $this->param;
        $objModel = model('GoodsCategory');
        $map['status'] = 1;
