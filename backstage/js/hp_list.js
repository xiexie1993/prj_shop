$(function(){
  var tableMes = {
    ...
    columns:[
      ...
      /* {field: 'article_id',title: '文章ID',align: 'center',valign: 'middle'},*/
      {field: 'title',title: '文章标题',align: 'center',valign: 'middle'},
      {field: 'author',title: '作者',align: 'center',valign: 'middle'},
...
function getDocType(){
	var resultType = ajaxMethod('helpTypeListall');
...
function operateFn(id){
  ...
  return {
    new: function() {
      ...
      // addChange('new');
      var categorydata = ajaxMethod('helpTypeListall');
      // console.log(data);
    ...
    change: function() {
    	//alert(that.data);
      var data = ajaxMethod('helpShoeOne',that.data);
      var categorydata = ajaxMethod('helpTypeListall');
      // console.log(data);
      // console.log(categorydata);
      // 组装 下拉分类选择框
