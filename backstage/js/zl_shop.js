$(function(){
  var tableMes = {
    ...
    columns:[
      ...
      {field: 'name',title: '产品标题',align: 'center',valign: 'middle'},
      
      {field: 'cover',title: '套餐名称',align: 'center',valign: 'middle'},
      {field: 'sort',title: '品牌',align: 'center',valign: 'middle'},
      {field: 'sort',title: '型号',align: 'center',valign: 'middle'},
      {field: 'sort',title: '参数配置',align: 'center',valign: 'middle'},
      {field: 'price',title: '租金',align: 'center',valign: 'middle'},
      {field: 'sort',title: '押金',align: 'center',valign: 'middle'},
      {field: 'sort',title: '数量',align: 'center',valign: 'middle'},
     
    
      
         {field: 'enable',title: '状态',align: 'center',valign: 'middle',formatter: function (value, row, index) {
       var status = agreedDataReturn(row.enable,agreedData.statusOpposite);
       return status;
      }},
...
function operateFn(id){
  ...
  return {
    ...
    change: function() {
    	//alert(that.data);
      var data = ajaxMethod('leaseShowone',that.data);
      console.log(data);
...
function sure (id) {
  switch(operateStr){
    ...
    case "change":
      ...
      var result = ajaxMethod('leaseEdit',formData);
       console.log(result);
      if(result.status != '0'){
        $('#roleMes').modal('hide');
        bstpTable.inint({});
